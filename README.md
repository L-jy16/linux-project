...
5. 수행 결과
   ...
   - SSH 서버 설치 및 보안 설정
     ...
     SSH는 원격으로 서버에 접속하는 기능입니다. 기본 포트로 지정되어 있던 22번을 20022번으로 변경했습니다. Root 계정은 모든 권한을 갖고 있어 해킹이 된다면 위험하기 때문에 Root로 직접 로그인하는 것을 막았습니다.
   ...
   - 사용자 계정 생성
     ...
     서비스 운영에 필요한 사용자 계정을 운영자, 개발자, 테스트로 나누어 생성하여 계정을 관리하였습니다.
